...
The build smoke test imports the packaged SDK from an isolated temporary directory, checks every SDK method used by Homey, and rejects dependency fallback into the development installation.
