...
const actions = [
  ...
  { id: "sleep_now", title: "Put to sleep", hint: "The Toniebox cannot be woken remotely; squeeze an ear to wake it.", method: "sleepNow" },
  { id: "refresh", title: "Refresh settings", method: "refresh" }
];
...
const triggers = [
  ...
  { id: "box_online", title: "Came online" },
  { id: "box_offline", title: "Went offline" },
  ...
  { id: "settings_applied", title: "Settings were applied" }
];

const conditions = [
  { id: "is_playing", title: "Playback !{{is|is not}} active", capability: "speaker_playing" },
  { id: "is_online", title: "!{{Is|Is not}} online", capability: "toniebox_online" },
